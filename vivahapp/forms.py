...
class Profileregister(forms.ModelForm):
    class Meta:
        model = profiles
        fields = [
            "name","gender","dateOfBirth","martialStatus","religion","image"
        ]

        # fields = [
        #      "martialStatus", "body_Type", "height", "weight", "drink",
...
class Profileupdate(forms.ModelForm):
    class Meta:
        model = profiles
        fields = [
            "martialStatus", "height", "image", "body_Type", "weight", "drink", "smoke", "motherTongue", "blood_group",
